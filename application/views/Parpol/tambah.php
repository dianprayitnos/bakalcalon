            ...
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Tambah Sekertaris</h3>
                </div>

                <form class="form-horizontal" method="POST" action="<?php echo base_url('index.php/pengguna/sekertaris/insert'); ?>">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Sekertaris" required>
                    </div>
                  </div>
