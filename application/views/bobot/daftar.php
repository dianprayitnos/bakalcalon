      ...
      <div class="content-wrapper">
        ...
        <section class="content">
              ...
              <table id="table_Kriteria" class="table table-bordered table-hover" sytle="margin-bottom: 10px;"> 
                ...
                <tbody>
                  ...
                  <?php $no=1; foreach ($list_Kriteria as $Kriteria) {                    
                    ...
                    echo '</center></td>';
                    echo '<td><input type="button" class="ion ion-plus" onclick="myFunction('.$Kriteria->id_kriteria.')"></td>';
                      "</tr>";
                    $no++;
                  }
                  ?>
          ...
          {            
            ...
            tbl += "<a class= 'btn btn-primary btn-flat'  href=<?php echo base_url('index.php/Kriteria/tambah'); ?>><i class=fa fa-plus></i>&nbsp;&nbsp;&nbsp;Tambah Kriteria</a>";
            tbl += "</div>";
            tbl += "<table class=table table-bordered table-hover sytle=margin-bottom: 10px;>";            
            tbl += "<thead><tr><th>NO</th><th>Nama Kriteria</th><th>Bobot</th></tr></thead>";
            var ri=0;
            var no=1;
